...
selected_columns=['numbaths', 'livearea', 'netprice']
...
train_data, test_data, train_targets, test_targets = train_test_split(np_array_features, np_array_target, test_size=.3)
